		...
		if (dynamicDpad != null)
		{
			...
			if (dynamicDpad.HasTouch)
			{
				if (dpad != null)
				{
					...
					// Show the d-pad
					if (dpad.gameObject.activeSelf != dynamicDpad.HasTouch)
					{
						dpad.SetActive(dynamicDpad.HasTouch);
					}
				}
				if (dpadKnob != null)
				{
					...
					// Show the d-pad knob
					if (dpadKnob.gameObject.activeSelf != dynamicDpad.HasTouch)
					{
						dpadKnob.SetActive(dynamicDpad.HasTouch);
					}
				}
			}
			else
			{
				if ((dpad != null) && (dpad.gameObject.activeSelf != dynamicDpad.HasTouch))
				{
					// Hide the d-pad
					dpad.SetActive(dynamicDpad.HasTouch);
				}
				if ((dpadKnob != null) && (dpadKnob.gameObject.activeSelf != dynamicDpad.HasTouch))
				{
					// Hide the d-pad knob
					dpadKnob.SetActive(dynamicDpad.HasTouch);
				}
